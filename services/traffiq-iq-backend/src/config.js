...
export const config = {
  ...
  // Deliberately non-empty invalid audience: Google sign-in fails closed until
  // the real Android web client ID is configured on the production host.
  googleWebClientId: process.env.GOOGLE_WEB_CLIENT_ID ?? '__not_configured__',
